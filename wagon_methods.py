...
# method 5
def test_match_spike_runs(df, player_name, inns, run_values):
    ...
    player_data = player_data[player_data['batsmanRuns'].isin(run_values)]
    if player_data.empty:
    ...
    ax.text(180, 370, f"Total Runs: {total_score} in Inns: {inns} ({balls_faced_df.shape[0]} balls)",
            fontsize=12, ha='center', va='center', fontweight='bold', color='black')
