...
st.set_page_config(page_title="Staging Wagons Analysis App" ,page_icon="🏏" ,layout="wide")
st.title("🏏 Staging Wagon Wheel Analysis Dashboard")
...
# ===== BATCH PLOT GENERATION SECTION (Updated)=====
if st.session_state.df is not None:
    st.sidebar.markdown("---")
...
# # ===== BATCH PLOT GENERATION SECTION (OLD) =====
# if st.session_state.df is not None:
#     st.sidebar.markdown("---")
#     st.sidebar.header("📋 Batch Plot Generation")
...
#                     batch_plot_types = st.sidebar.multiselect(
#                         "Select plots to generate:",
#                     ["Spike Plot", "Spike Plot Descriptive", "Wagon Zone Plot", "Wagon Zone Descriptive", "Dismissal Plot"],
#                     )
...
#                                     # Generate selected plots
#                                     try:
#                                         if "Spike Plot" in batch_plot_types:
#                                             spike_filters = {k: v for k, v in batch_filters.items()}
#                                             fig = spike_plot_custom(df=df, pid=pid, player_name=None, **spike_filters)
#                                             if fig is not None:
